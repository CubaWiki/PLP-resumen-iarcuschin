...
Entonces, decimos que el constructor de tipos de función es \xbf{contravariante} en su primer argumento y \xbf{variante} en el segundo.
...
\todo{Revisar lo de más específico y más general}
...
Lo interesante de las referencias es que no son contravariantes ni variantes, son \xbf{invariantes}. Es decir: solo podemos comparar referencias de tipos equivalentes:
