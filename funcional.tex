...
\subsubsection{Pattern matching} es un mecanismo para acceder a los parametros con los que fue construido un Tipo Algebráico. \xbf{Pattern} es una expresión utilizando constructores y variables sin repetir. \xbf{Matching} es la operación que dice si una expresión es de la forma de un patrón.
