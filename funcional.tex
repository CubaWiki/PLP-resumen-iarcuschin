...
\begin{itemize}
  ...
  \item Y los juicios de evaluación, en vez de ser de la forma $M \to M'$, ahora son  $M \vert \mu \to M' \vert \mu'$.
\end{itemize}
...
\todo{Falta mostrar que hay que reformular esos conceptos, porque los rompimos al introducir el sistema de tipos para las direcciones}
